...
export const products: Product[] = [
  {
    ...
    category: "dress",
    price: 1899,
    imageUrl: "/images/products/dress_01.png",
    rating: 3.8,
    ratingCount: 1245,
    savedDaysAgo: 2,
    attributes: [
  ...
  },
  {
    ...
    category: "shirt",
    price: 3499,
    imageUrl: "/images/products/shirt_01.png",
    rating: 4.6,
    ratingCount: 312,
    savedDaysAgo: 5,
    attributes: [
  ...
  },
  {
    ...
    price: 8999,
    originalPrice: 12999,
    imageUrl: "/images/products/lehenga_01.png",
    rating: 4.1,
    ratingCount: 45,
    savedDaysAgo: 12,
    attributes: [
  ...
  },
  {
    ...
    price: 2499,
    originalPrice: 5999,
    imageUrl: "/images/products/sneakers_01.png",
    rating: 4.4,
    ratingCount: 8900,
    savedDaysAgo: 1,
    attributes: [
  ...
  },
  {
    ...
    category: "top",
    price: 1299,
    imageUrl: "/images/products/top_01.png",
    rating: 3.5,
    ratingCount: 89,
    savedDaysAgo: 4,
    attributes: [
  ...
  },
  {
    ...
    category: "trousers",
    price: 1499,
    imageUrl: "/images/products/trousers_01.png",
    rating: 4.7,
    ratingCount: 4120,
    savedDaysAgo: 10,
    attributes: [
